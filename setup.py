...
setup(
    ...
    package_dir={
        ...
        'alameda_api.v1alpha1.datahub.data': 'alameda_api/v1alpha1/datahub/data',
        ...
        'alameda_api.v1alpha1.datahub.keycodes': 'alameda_api/v1alpha1/datahub/keycodes',
