...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  serialized_pb=_b('\n(datahub/resource/v1alpha2/resource.proto\x12&containersai.datahub.resource.v1alpha2\x1a\x31\x64\x61tahub/resource/metadata/v1alpha2/metadata.proto\x1a,datahub/prediction/v1alpha2/prediction.proto\x1a\x1fgoogle/protobuf/timestamp.proto\x1a$datahub/metric/v1alpha2/metric.proto\"\xaf\x01\n\tContainer\x12\x0c\n\x04name\x18\x01 \x01(\t\x12H\n\x0elimit_resource\x18\x02 \x03(\x0b\x32\x30.containersai.datahub.metric.v1alpha2.MetricData\x12J\n\x10request_resource\x18\x03 \x03(\x0b\x32\x30.containersai.datahub.metric.v1alpha2.MetricData\"\xb2\x03\n\x03Pod\x12X\n\x0fnamespaced_name\x18\x01 \x01(\x0b\x32?.containersai.datahub.resource.metadata.v1alpha2.NamespacedName\x12\x15\n\rresource_link\x18\x02 \x01(\t\x12\x45\n\ncontainers\x18\x03 \x03(\x0b\x32\x31.containersai.datahub.resource.v1alpha2.Container\x12\x0f\n\x07predict\x18\x04 \x01(\x08\x12O\n\x06scaler\x18\x05 \x01(\x0b\x32?.containersai.datahub.resource.metadata.v1alpha2.NamespacedName\x12\x11\n\tnode_name\x18\x06 \x01(\t\x12.\n\nstart_time\x18\x07 \x01(\x0b\x32\x1a.google.protobuf.Timestamp\x12N\n\x06policy\x18\x08 \x01(\x0e\x32>.containersai.datahub.prediction.v1alpha2.RecommendationPolicy\"\x14\n\x04Node\x12\x0c\n\x04name\x18\x01 \x01(\tb\x06proto3')
  ,
...
_POD = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='predict', full_name='containersai.datahub.resource.v1alpha2.Pod.predict', index=3,
...
_CONTAINER.fields_by_name['limit_resource'].message_type = datahub_dot_metric_dot_v1alpha2_dot_metric__pb2._METRICDATA
_CONTAINER.fields_by_name['request_resource'].message_type = datahub_dot_metric_dot_v1alpha2_dot_metric__pb2._METRICDATA
