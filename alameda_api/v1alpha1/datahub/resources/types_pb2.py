...
_ALAMEDAAPPLICATIONSPEC = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='MinReplicas', full_name='containersai.alameda.v1alpha1.datahub.resources.AlamedaApplicationSpec.MinReplicas', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='MaxReplicas', full_name='containersai.alameda.v1alpha1.datahub.resources.AlamedaApplicationSpec.MaxReplicas', index=2,
