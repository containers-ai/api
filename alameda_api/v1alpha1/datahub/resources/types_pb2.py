...
_ALAMEDACONTROLLERSPEC = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='min_replicas', full_name='containersai.alameda.v1alpha1.datahub.resources.AlamedaControllerSpec.min_replicas', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='max_replicas', full_name='containersai.alameda.v1alpha1.datahub.resources.AlamedaControllerSpec.max_replicas', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='enable_recommendation_execution', full_name='containersai.alameda.v1alpha1.datahub.resources.AlamedaControllerSpec.enable_recommendation_execution', index=5,
...
_ALAMEDANODESPEC = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='machineset_name', full_name='containersai.alameda.v1alpha1.datahub.resources.AlamedaNodeSpec.machineset_name', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='machineset_namespace', full_name='containersai.alameda.v1alpha1.datahub.resources.AlamedaNodeSpec.machineset_namespace', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='role_master', full_name='containersai.alameda.v1alpha1.datahub.resources.AlamedaNodeSpec.role_master', index=3,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='role_worker', full_name='containersai.alameda.v1alpha1.datahub.resources.AlamedaNodeSpec.role_worker', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='role_infra', full_name='containersai.alameda.v1alpha1.datahub.resources.AlamedaNodeSpec.role_infra', index=5,
      number=6, type=8, cpp_type=7, label=1,
      has_default_value=False, default_value=False,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
