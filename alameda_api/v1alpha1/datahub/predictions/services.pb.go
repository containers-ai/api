...
type CreatePredictionsRequest struct {
	Predictions          []*WritePrediction `protobuf:"bytes,1,rep,name=predictions,proto3" json:"predictions,omitempty"`
...
type ListPredictionsResponse struct {
	Status               *status.Status  `protobuf:"bytes,1,opt,name=status,proto3" json:"status,omitempty"`
	Predictions          *ReadPrediction `protobuf:"bytes,2,opt,name=predictions,proto3" json:"predictions,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}
...
func (m *ListPredictionsResponse) GetPredictions() *ReadPrediction {
	if m != nil {
		return m.Predictions
	}
	return nil
...
var fileDescriptor_f99ee8b129e06c96 = []byte{
	...
	,
}
