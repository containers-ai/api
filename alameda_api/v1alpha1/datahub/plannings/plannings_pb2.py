...
_READPLANNING = _descriptor.Descriptor(
  name='ReadPlanning',
  full_name='containersai.alameda.v1alpha1.datahub.plannings.ReadPlanning',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='schema_meta', full_name='containersai.alameda.v1alpha1.datahub.plannings.ReadPlanning.schema_meta', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='plannings', full_name='containersai.alameda.v1alpha1.datahub.plannings.ReadPlanning.plannings', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_WRITEPLANNING = _descriptor.Descriptor(
  name='WritePlanning',
  full_name='containersai.alameda.v1alpha1.datahub.plannings.WritePlanning',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='schema_meta', full_name='containersai.alameda.v1alpha1.datahub.plannings.WritePlanning.schema_meta', index=0,
      number=1, type=11, cpp_type=10, label=1,
      has_default_value=False, default_value=None,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='plannings', full_name='containersai.alameda.v1alpha1.datahub.plannings.WritePlanning.plannings', index=1,
      number=2, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_READPLANNING.fields_by_name['schema_meta'].message_type = alameda__api_dot_v1alpha1_dot_datahub_dot_schemas_dot_types__pb2._SCHEMAMETA
_READPLANNING.fields_by_name['plannings'].message_type = alameda__api_dot_v1alpha1_dot_datahub_dot_common_dot_metrics__pb2._READMETRICDATA
_WRITEPLANNING.fields_by_name['schema_meta'].message_type = alameda__api_dot_v1alpha1_dot_datahub_dot_schemas_dot_types__pb2._SCHEMAMETA
_WRITEPLANNING.fields_by_name['plannings'].message_type = alameda__api_dot_v1alpha1_dot_datahub_dot_common_dot_metrics__pb2._WRITEMETRICDATA
...
DESCRIPTOR.message_types_by_name['ReadPlanning'] = _READPLANNING
...
ReadPlanning = _reflection.GeneratedProtocolMessageType('ReadPlanning', (_message.Message,), {
  'DESCRIPTOR' : _READPLANNING,
  '__module__' : 'alameda_api.v1alpha1.datahub.plannings.plannings_pb2'
  # @@protoc_insertion_point(class_scope:containersai.alameda.v1alpha1.datahub.plannings.ReadPlanning)
  })
_sym_db.RegisterMessage(ReadPlanning)

WritePlanning = _reflection.GeneratedProtocolMessageType('WritePlanning', (_message.Message,), {
  'DESCRIPTOR' : _WRITEPLANNING,
  '__module__' : 'alameda_api.v1alpha1.datahub.plannings.plannings_pb2'
  # @@protoc_insertion_point(class_scope:containersai.alameda.v1alpha1.datahub.plannings.WritePlanning)
  })
